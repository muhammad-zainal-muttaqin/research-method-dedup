# `M13_stack_bracket` — Primary Metrics Breakdown

**Implementasi:** [`algorithms/M13_stack_bracket.py`](../../algorithms/M13_stack_bracket.py)  
**Dataset:** 228 pohon JSON (953 baris cocok dengan `method=M13_stack_bracket`)  
**Raw data lengkap:** [`../benchmark_multidim/accuracy_per_tree.csv`](../benchmark_multidim/accuracy_per_tree.csv)  
**Per-method slice (filter sudah diterapkan):** [`M13_stack_bracket_per_tree.csv`](M13_stack_bracket_per_tree.csv)  
...
|---|---:|---|
| Macro class-MAE | **0.4231** | mean(per-class MAE) |
| Exact accuracy | **25.39%** | 242/953 pohon dengan err_B* = 0 di semua kelas |
| Total count MAE | **1.5519** | mean \|Σpred − Σgt\| per pohon |
| Total ±1 accuracy | **68.63%** | 654/953 pohon dengan \|Σpred − Σgt\| ≤ 1 |
...
| B4 | **0.3169** | mean(err_B4) across 953 pohon |
...
| B4 | **+0.044** | mean(pred_B4 − gt_B4) across 953 pohon |

## Kecepatan (pelengkap)

Sumber: [`speed_summary.csv`](../benchmark_multidim/speed_summary.csv) (30 repetisi × 953 pohon)

- Mean: **0.0524 ms/pohon** (19,072 pohon/detik)
- Median: 0.0483 ms
- Std: 0.0095 ms
...
|---:|---:|---:|---:|---:|
| 0% | 84.78% | 0.4231 | 145 | +0.00% |
| 5% | 83.42% | 0.4444 | 158 | +1.36% |
| 10% | 82.79% | 0.4520 | 164 | +1.99% |
| 20% | 82.69% | 0.4523 | 165 | +2.09% |
