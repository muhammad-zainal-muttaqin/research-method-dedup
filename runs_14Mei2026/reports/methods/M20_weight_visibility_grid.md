# `M20_weight_visibility_grid` — Primary Metrics Breakdown

**Implementasi:** [`algorithms/M20_weight_visibility_grid.py`](../../algorithms/M20_weight_visibility_grid.py)  
**Dataset:** 228 pohon JSON (953 baris cocok dengan `method=M20_weight_visibility_grid`)  
**Raw data lengkap:** [`../benchmark_multidim/accuracy_per_tree.csv`](../benchmark_multidim/accuracy_per_tree.csv)  
**Per-method slice (filter sudah diterapkan):** [`M20_weight_visibility_grid_per_tree.csv`](M20_weight_visibility_grid_per_tree.csv)  
...
- Mean: **0.0374 ms/pohon** (26,766 pohon/detik)
- Median: 0.0372 ms
- Std: 0.0005 ms
