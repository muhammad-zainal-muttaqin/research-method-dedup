# `M11_median_b2` — Primary Metrics Breakdown

**Implementasi:** [`algorithms/M11_median_b2.py`](../../algorithms/M11_median_b2.py)  
**Dataset:** 228 pohon JSON (953 baris cocok dengan `method=M11_median_b2`)  
**Raw data lengkap:** [`../benchmark_multidim/accuracy_per_tree.csv`](../benchmark_multidim/accuracy_per_tree.csv)  
**Per-method slice (filter sudah diterapkan):** [`M11_median_b2_per_tree.csv`](M11_median_b2_per_tree.csv)  
...
|---|---:|---|
| Macro class-MAE | **0.4242** | mean(per-class MAE) |
| Exact accuracy | **23.71%** | 226/953 pohon dengan err_B* = 0 di semua kelas |
| Total count MAE | **1.5477** | mean \|Σpred − Σgt\| per pohon |
| Total ±1 accuracy | **69.99%** | 667/953 pohon dengan \|Σpred − Σgt\| ≤ 1 |
| Acc ±1 per kelas per pohon (pelengkap) | 84.99% | 810/953 pohon dengan semua err_B* dalam ±1 |
...
|---|---:|---|
| B1 | **0.1952** | mean(err_B1) across 953 pohon |
| B2 | **0.3242** | mean(err_B2) across 953 pohon |
| B3 | **0.8531** | mean(err_B3) across 953 pohon |
...
|---|---:|---:|---:|---:|---:|---:|
| B1 | 0.1952 | 25 | 0 | 812 | 928 | 97.38% |
| B2 | 0.3242 | 33 | 13 | 740 | 907 | 95.17% |
| B3 | 0.8531 | 92 | 16 | 458 | 845 | 88.67% |
| B4 | 0.3242 | 15 | 11 | 686 | 927 | 97.27% |
...
|---|---:|---|
| B1 | **+0.149** | mean(pred_B1 − gt_B1) across 953 pohon |
| B2 | **+0.129** | mean(pred_B2 − gt_B2) across 953 pohon |
| B3 | **+0.488** | mean(pred_B3 − gt_B3) across 953 pohon |
...
- Mean: **0.4503 ms/pohon** (2,220 pohon/detik)
- Median: 0.4501 ms
- Std: 0.0030 ms
...
|---:|---:|---:|---:|---:|
| 0% | 84.99% | 0.4242 | 143 | +0.00% |
| 5% | 84.58% | 0.4281 | 147 | +0.41% |
| 10% | 84.37% | 0.4321 | 149 | +0.62% |
| 20% | 83.63% | 0.4402 | 156 | +1.36% |

## Pohon yang Gagal (Acc±1 fail = 143)
...
| `DAMIMAS_A21B_0447` | train | DAMIMAS | 1.00 | 0 | 2 | 2 | 0 |
...
| `DAMIMAS_A21B_0539` | train | DAMIMAS | 0.50 | 0 | 0 | 2 | 0 |
...
| `DAMIMAS_A21B_0812` | val | DAMIMAS | 3.50 | 5 | 3 | 6 | 0 |
...
| `DAMIMAS_A21B_0816` | train | DAMIMAS | 2.75 | 2 | 4 | 5 | 0 |
...
| `DAMIMAS_A21B_0832` | train | DAMIMAS | 3.25 | 0 | 5 | 7 | 1 |
| `DAMIMAS_A21B_0833` | train | DAMIMAS | 1.25 | 3 | 0 | 2 | 0 |
| `DAMIMAS_A21B_0834` | train | DAMIMAS | 3.75 | 1 | 5 | 5 | 4 |
...
| `DAMIMAS_A21B_0851` | train | DAMIMAS | 3.50 | 0 | 5 | 8 | 1 |
