# `M12_selector_overrides` — Primary Metrics Breakdown

**Implementasi:** [`algorithms/M12_selector_overrides.py`](../../algorithms/M12_selector_overrides.py)  
**Dataset:** 228 pohon JSON (953 baris cocok dengan `method=M12_selector_overrides`)  
**Raw data lengkap:** [`../benchmark_multidim/accuracy_per_tree.csv`](../benchmark_multidim/accuracy_per_tree.csv)  
**Per-method slice (filter sudah diterapkan):** [`M12_selector_overrides_per_tree.csv`](M12_selector_overrides_per_tree.csv)  
...
|---|---:|---|
| Macro class-MAE | **0.4342** | mean(per-class MAE) |
| Exact accuracy | **23.19%** | 221/953 pohon dengan err_B* = 0 di semua kelas |
| Total count MAE | **1.5855** | mean \|Σpred − Σgt\| per pohon |
| Total ±1 accuracy | **68.73%** | 655/953 pohon dengan \|Σpred − Σgt\| ≤ 1 |
...
| B2 | **0.3652** | mean(err_B2) across 953 pohon |
| B3 | **0.8531** | mean(err_B3) across 953 pohon |
| B4 | **0.3232** | mean(err_B4) across 953 pohon |
...
| B2 | 0.3652 | 43 | 6 | 723 | 904 | 94.86% |
| B3 | 0.8531 | 91 | 16 | 457 | 846 | 88.77% |
| B4 | 0.3232 | 14 | 11 | 686 | 928 | 97.38% |
...
| B2 | **+0.239** | mean(pred_B2 − gt_B2) across 953 pohon |
| B3 | **+0.484** | mean(pred_B3 − gt_B3) across 953 pohon |
| B4 | **+0.036** | mean(pred_B4 − gt_B4) across 953 pohon |

## Kecepatan (pelengkap)

Sumber: [`speed_summary.csv`](../benchmark_multidim/speed_summary.csv) (30 repetisi × 953 pohon)

- Mean: **0.0994 ms/pohon** (10,060 pohon/detik)
- Median: 0.0995 ms
- Std: 0.0007 ms
...
|---:|---:|---:|---:|---:|
| 0% | 84.99% | 0.4342 | 143 | +0.00% |
| 5% | 84.58% | 0.4373 | 147 | +0.41% |
| 10% | 84.26% | 0.4412 | 150 | +0.73% |
| 20% | 83.53% | 0.4486 | 157 | +1.46% |
