# `M17_selector_regime` — Primary Metrics Breakdown

**Implementasi:** [`algorithms/M17_selector_regime.py`](../../algorithms/M17_selector_regime.py)  
**Dataset:** 228 pohon JSON (953 baris cocok dengan `method=M17_selector_regime`)  
**Raw data lengkap:** [`../benchmark_multidim/accuracy_per_tree.csv`](../benchmark_multidim/accuracy_per_tree.csv)  
**Per-method slice (filter sudah diterapkan):** [`M17_selector_regime_per_tree.csv`](M17_selector_regime_per_tree.csv)  
...
|---|---:|---|
| Macro class-MAE | **0.4349** | mean(per-class MAE) |
| Exact accuracy | **22.88%** | 218/953 pohon dengan err_B* = 0 di semua kelas |
| Total count MAE | **1.5887** | mean \|Σpred − Σgt\| per pohon |
...
| B2 | **0.3673** | mean(err_B2) across 953 pohon |
...
| B2 | **+0.243** | mean(pred_B2 − gt_B2) across 953 pohon |
...
- Mean: **0.1458 ms/pohon** (6,859 pohon/detik)
- Median: 0.1515 ms
- Std: 0.0122 ms
...
|---:|---:|---:|---:|---:|
| 0% | 84.78% | 0.4349 | 145 | +0.00% |
| 5% | 84.58% | 0.4378 | 147 | +0.20% |
| 10% | 84.26% | 0.4412 | 150 | +0.52% |
| 20% | 83.53% | 0.4488 | 157 | +1.25% |
