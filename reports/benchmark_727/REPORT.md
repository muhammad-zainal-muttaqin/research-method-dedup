...
|---:|---|---:|---:|---:|---:|
| 1 | `v1_corrected` | 0.0040 | 0.0038 | 0.0005 | 248808 |
| 2 | `v5_adaptive_corrected` | 0.0079 | 0.0076 | 0.0007 | 126980 |
| 3 | `v7_stacking_density` | 0.0151 | 0.0153 | 0.0017 | 66044 |
| 4 | `v2_visibility` | 0.0230 | 0.0230 | 0.0009 | 43466 |
| 5 | `v5_best_visibility` | 0.0231 | 0.0232 | 0.0011 | 43217 |
| 6 | `v8_b2_b4_boosted` | 0.0492 | 0.0489 | 0.0010 | 20328 |
| 7 | `v7_stacking_bracketed` | 0.0493 | 0.0492 | 0.0010 | 20304 |
| 8 | `v9_selector` | 0.0803 | 0.0802 | 0.0013 | 12460 |
| 9 | `v6_selector` | 0.1007 | 0.1004 | 0.0012 | 9934 |
| 10 | `v8_entropy_modulated` | 0.1048 | 0.1047 | 0.0008 | 9545 |
| 11 | `v9_b2_median_v6` | 0.4284 | 0.4272 | 0.0039 | 2334 |
...
|---|---:|---:|---:|---:|---:|---:|
| `v2_visibility` | 89.41% | #1 | 0.023 | #4 | 3.44% | #11 |
| `v5_best_visibility` | 89.41% | #2 | 0.023 | #5 | 3.44% | #10 |
| `v9_selector` | 89.27% | #3 | 0.080 | #8 | 2.47% | #8 |
| `v9_b2_median_v6` | 89.00% | #4 | 0.428 | #11 | 2.34% | #7 |
| `v6_selector` | 88.86% | #5 | 0.101 | #9 | 2.34% | #6 |
| `v8_entropy_modulated` | 88.86% | #6 | 0.105 | #10 | 2.89% | #9 |
| `v7_stacking_bracketed` | 88.45% | #7 | 0.049 | #7 | 2.34% | #4 |
| `v7_stacking_density` | 88.45% | #8 | 0.015 | #3 | 2.34% | #5 |
| `v1_corrected` | 87.90% | #9 | 0.004 | #1 | 0.00% | #1 |
| `v8_b2_b4_boosted` | 87.62% | #10 | 0.049 | #6 | 1.93% | #3 |
| `v5_adaptive_corrected` | 86.11% | #11 | 0.008 | #2 | 0.00% | #2 |
