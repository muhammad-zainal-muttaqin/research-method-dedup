...
|---:|---|---:|---:|---:|---:|
| 1 | `v1_corrected` | 0.0039 | 0.0035 | 0.0012 | 255885 |
| 2 | `v5_adaptive_corrected` | 0.0110 | 0.0103 | 0.0031 | 90682 |
| 3 | `v7_stacking_density` | 0.0155 | 0.0152 | 0.0017 | 64643 |
| 4 | `v2_visibility` | 0.0280 | 0.0268 | 0.0039 | 35698 |
| 5 | `v5_best_visibility` | 0.0299 | 0.0284 | 0.0051 | 33402 |
| 6 | `v8_b2_b4_boosted` | 0.0473 | 0.0460 | 0.0028 | 21161 |
| 7 | `v7_stacking_bracketed` | 0.0505 | 0.0501 | 0.0027 | 19820 |
| 8 | `v9_selector` | 0.0746 | 0.0742 | 0.0013 | 13400 |
| 9 | `v8_entropy_modulated` | 0.1064 | 0.1062 | 0.0046 | 9394 |
| 10 | `v6_selector` | 0.1083 | 0.1050 | 0.0090 | 9234 |
| 11 | `v9_b2_median_v6` | 0.4156 | 0.4110 | 0.0081 | 2406 |
...
|---|---:|---:|---:|---:|---:|---:|
| `v9_selector` | 97.37% | #1 | 0.075 | #8 | 2.63% | #11 |
| `v9_b2_median_v6` | 96.05% | #2 | 0.416 | #11 | 2.19% | #10 |
| `v6_selector` | 96.05% | #3 | 0.108 | #10 | 2.19% | #9 |
| `v7_stacking_bracketed` | 94.30% | #4 | 0.051 | #7 | 0.44% | #5 |
| `v7_stacking_density` | 94.30% | #5 | 0.015 | #3 | 0.44% | #4 |
| `v8_entropy_modulated` | 94.30% | #6 | 0.106 | #9 | 1.32% | #8 |
| `v5_adaptive_corrected` | 93.86% | #7 | 0.011 | #2 | 0.00% | #3 |
| `v8_b2_b4_boosted` | 92.54% | #8 | 0.047 | #6 | -0.88% | #1 |
| `v2_visibility` | 92.54% | #9 | 0.028 | #4 | 0.87% | #7 |
| `v5_best_visibility` | 92.54% | #10 | 0.030 | #5 | 0.87% | #6 |
