...
|---:|---|---:|---:|---:|---:|
| 1 | `v1_corrected` | 0.0037 | 0.0034 | 0.0005 | 272135 |
| 2 | `v5_adaptive_corrected` | 0.0075 | 0.0073 | 0.0006 | 133011 |
| 3 | `v7_stacking_density` | 0.0139 | 0.0136 | 0.0009 | 72122 |
| 4 | `v5_best_visibility` | 0.0228 | 0.0227 | 0.0010 | 43903 |
| 5 | `v2_visibility` | 0.0240 | 0.0240 | 0.0012 | 41677 |
| 6 | `v8_b2_b4_boosted` | 0.0485 | 0.0485 | 0.0012 | 20626 |
| 7 | `v7_stacking_bracketed` | 0.0488 | 0.0481 | 0.0036 | 20482 |
| 8 | `v9_selector` | 0.0805 | 0.0796 | 0.0031 | 12420 |
| 9 | `v6_selector` | 0.1016 | 0.1014 | 0.0017 | 9847 |
| 10 | `v8_entropy_modulated` | 0.1032 | 0.1031 | 0.0018 | 9691 |
| 11 | `v9_b2_median_v6` | 0.4281 | 0.4266 | 0.0042 | 2336 |
...
|---|---:|---:|---:|---:|---:|---:|
| `v9_b2_median_v6` | 92.68% | #1 | 0.428 | #11 | 1.89% | #10 |
| `v9_selector` | 92.68% | #2 | 0.081 | #8 | 2.09% | #11 |
| `v7_stacking_bracketed` | 91.84% | #3 | 0.049 | #7 | 1.88% | #8 |
| `v6_selector` | 91.84% | #4 | 0.102 | #9 | 1.67% | #6 |
| `v7_stacking_density` | 91.84% | #5 | 0.014 | #3 | 1.88% | #9 |
| `v8_entropy_modulated` | 91.63% | #6 | 0.103 | #10 | 1.67% | #7 |
| `v8_b2_b4_boosted` | 91.00% | #7 | 0.049 | #6 | 1.04% | #3 |
| `v2_visibility` | 90.38% | #8 | 0.024 | #5 | 1.05% | #4 |
